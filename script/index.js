...
$('.h_right> li> a').click(function () {
    $('.popup_back').fadeIn();//show(); 
});

$('.popup_back a').click(function () {
    $('.popup_back').fadeOut(); //hide();
});

$('.h_left> li> a').click(function () {
    $('.popup_back2').fadeIn();//show(); 
});

$('.popup_back2 a').click(function () {
    $('.popup_back2').fadeOut(); //hide();
});
